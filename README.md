...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/goosebib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8594&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/goosebib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `goosebib` can be installed with:

```
conda install goosebib
```

It is possible to list all of the versions of `goosebib` available on your platform with:
